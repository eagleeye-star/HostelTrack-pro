...
export default function App() {
  ...
  const [setupDone, setSetupDone] = useState(()=>!!localStorage.getItem("hostel_setup"));
  const [institution, setInstitution] = useState(()=>loadInstitution("hostelManagerPro_v1_license"));
